...
function Calculadora() {
  ...
  function definirOperacao(op){
    ...
    //Caso a operação esteja definida e o número 2 carregado, realize o cálculo da operação.
    if(numero2 !== null){
    ...
    <Jumbotron style={{
      ...
      <Container>
        ...
        <Row>
          ...
          <Col>
            <Button variant="warning"
                    onClick={() => definirOperacao(DIVISAO)}>{DIVISAO}</Button>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col>
            <Button variant="warning"
                    onClick={() => definirOperacao(MULTIPLICACAO)}>{MULTIPLICACAO}</Button>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col>
            <Button variant="warning"
                    onClick={() => definirOperacao(SUBTRACAO)}>{SUBTRACAO}</Button>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col>
            <Button variant="warning"
                    onClick={() => definirOperacao(SOMA)}>{SOMA}</Button>
          </Col>
        </Row>
      </Container>
